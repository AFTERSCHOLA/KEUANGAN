 ...
 * server/schema.sql and re-seeds the four canonical test users plus the
 * `cbg-test-pusat` branch to a known canonical state. Idempotent: safe to
...
$dataTableCounts = [];
foreach (['absensi','audit_log','backups','honor_payments','invoices','login_attempts','photo_uploads','sekolah','settings','siswa','spp_payments','sync_log','trainer'] as $t) {
