...
const TABS = [
  ...
  { id: 'riwayat', label: 'Riwayat Absensi', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', comingSoon: true },
...
export default function App() {
  ...
  const PeriodSelectors = () => (
    <div className={`px-3 ${sidebarCollapsed ? 'hidden' : 'flex flex-col gap-2'}`}>
      <label className="text-[10px] font-extrabold text-blue-300 uppercase tracking-wider px-1">Tahun Ajaran</label>
      <select
